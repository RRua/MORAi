...
abstract class MemoizeClassVisitorFactory :
    ...
    companion object {
        const val MEMOIZE_DESCRIPTOR = "Lio/github/sanadlab/annotations/Memoize;"
        const val CACHE_INVALIDATE_DESCRIPTOR = "Lio/github/sanadlab/annotations/CacheInvalidate;"
    }
