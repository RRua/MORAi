...
# echo "▶️ Compiling Java sources with javac..."
# JAVA_CLASSES_DIR="build/classes/java/main"
# mkdir -p "$JAVA_CLASSES_DIR"

# javac -cp "$ANDROID_JAR:$R_JAR$PROCESSED_CP" \
...
# infer run --impurity -- kotlinc -cp "$ANDROID_JAR:$R_JAR$PROCESSED_CP:$JAVA_CLASSES_DIR" \
